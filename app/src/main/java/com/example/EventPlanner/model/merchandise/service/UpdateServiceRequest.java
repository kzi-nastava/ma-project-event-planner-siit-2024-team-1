...
public class UpdateServiceRequest {
    ...
    public UpdateServiceRequest(String title, String description, String specificity, Double price, Integer discount, List<Integer> eventTypesIds, Integer minDuration, Integer maxDuration, Integer reservationDeadline, Integer cancellationDeadline, Boolean automaticReservation, Boolean visible, Boolean available, List<Integer> photos, Integer serviceProviderId, Address address) {
        this.title = title;
